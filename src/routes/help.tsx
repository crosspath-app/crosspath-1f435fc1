...
export const Route = createFileRoute("/help")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Embassy contacts, lost passport steps, emergency numbers and official portals.",
      },
    ...
    links: [{ rel: "canonical", href: "https://crosspath.lovable.app/help" }],
    scripts: [
      {
          ...
          step: [
            {
              "@type": "HowToStep",
              name: "Stay calm",
              text: "Stay calm. Note the time and place where you last had your passport.",
            },
            {
              "@type": "HowToStep",
              name: "Report to police",
              text: "Report the loss to the local police and ask for a written report.",
            },
            {
              "@type": "HowToStep",
              name: "Contact embassy",
              text: "Contact your country's embassy or consulate to start an emergency travel document.",
            },
            {
              "@type": "HowToStep",
              name: "Notify insurance",
              text: "If you have travel insurance, notify them — many cover replacement fees.",
            },
          ],
        }),
      },
...
function HelpPage() {
  ...
  const QUICK: Array<{
    ...
    },
    {
      ...
      title: "Lost passport",
      value: "Step-by-step",
      note: "Report, file, request emergency travel doc",
      href: "#lost-passport",
    },
    {
      icon: Building2,
    ...
    },
    {
      ...
      value: "immigration.europa.eu",
      note: "Official guidance",
      href: "https://immigration-portal.ec.europa.eu/",
      external: true,
    },
  ];
  ...
  return (
    <AppShell>
      <PageHeader
        eyebrow="Help"
        title="Emergency help and resources"
        subtitle="Quick contacts and clear steps for the moments that matter."
      />

      <h2 className="px-6 text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">
        Quick contacts
      </h2>
        ...
        <ol className="mt-3 space-y-2">
          {STEPS.map((s, i) => (
            <li key={i} className="flex gap-3 rounded-xl border border-border bg-card p-3">
              <span
                className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md text-xs text-primary-foreground font-mono"
      ...
      <div className="mt-8 px-6">
        ...
        >
          ...
          <p className="mt-2 text-sm leading-relaxed text-foreground">
            Keep a digital copy of your passport, visa, and insurance card in your phone — Crosspath
            will soon let you store them encrypted.
          </p>
        </div>
      </div>
    </AppShell>
