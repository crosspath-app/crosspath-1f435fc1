...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Borderless — Move, study, work abroad without the bureaucracy" },
      ...
      { property: "og:title", content: "Borderless — Move, study, work abroad without the bureaucracy" },
      ...
      { name: "twitter:title", content: "Borderless — Move, study, work abroad without the bureaucracy" },
