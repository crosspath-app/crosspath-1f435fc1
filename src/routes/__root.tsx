...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free relocation planner with country-specific visa checklists, deadlines, cost calculators and plain-language immigration guides." },
      { name: "author", content: "Crosspath.move" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Crosspath.move" },
      { property: "og:title", content: "Crosspath.move — Relocation Checklists & Visa Guides" },
      { property: "og:description", content: "Free relocation planner with country-specific visa checklists, deadlines, cost calculators and plain-language immigration guides." },
