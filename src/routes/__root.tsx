  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7a24d0d5-0ee1-4006-97f5-d44d2bbd8c36/id-preview-4bcdb74e--ac0e1009-ab03-4504-8601-45b72557fc9c.lovable.app-1778756628402.png",
      },
      {
        name: "twitter:image",
        content:
