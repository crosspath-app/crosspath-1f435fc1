...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crosspath.move — Move abroad, skip the paperwork" },
      ...
      { property: "og:title", content: "Crosspath.move — Move abroad, skip the paperwork" },
      ...
      { name: "twitter:title", content: "Crosspath.move — Move abroad, skip the paperwork" },
