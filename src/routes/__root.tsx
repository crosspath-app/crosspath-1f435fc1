...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crosspath — Move abroad, skip the paperwork" },
      ...
      { name: "author", content: "Crosspath" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Crosspath" },
      { property: "og:title", content: "Crosspath — Move abroad, skip the paperwork" },
      ...
      { name: "twitter:title", content: "Crosspath — Move abroad, skip the paperwork" },
