...
export const TERMS: TermEntry[] = [
  {
    ...
    plain:
      "Show proof of where you'll stay — a rental contract, dorm acceptance letter, or hotel booking.",
  ...
  },
  {
    ...
    plain:
      "If you spend more than 183 days a year somewhere, that country can tax all your income.",
  },
  {
    term: "Schengen Area",
    bureaucratic: "Free movement is permitted within the Schengen Area subject to the 90/180 rule.",
    plain:
      "You can travel between 29 European countries without border checks — but only 90 days in any 180.",
  },
  {
    term: "Legalisation",
    bureaucratic: "Documents require consular legalisation.",
    plain:
      "If the country doesn't accept apostilles, the embassy must stamp your document instead.",
  },
  {
    ...
    plain:
      "An official translator (registered with a court) must translate the document — Google Translate doesn't count.",
  },
  {
    term: "Sperrkonto",
    ...
    plain:
      "A German bank account that locks your money and releases a monthly allowance — proves you can support yourself as a student.",
  },
  {
    term: "VAT number",
    bureaucratic: "Register for a national VAT identification number.",
    plain:
      "If you'll invoice clients as a freelancer, you need a tax number to charge sales tax legally.",
  },
  {
    term: "Right to work",
    bureaucratic: "Verify entitlement to engage in remunerated activity.",
    plain:
      "Check whether your visa actually lets you take a paid job — many tourist and student visas don't.",
  },
  {
    term: "Health insurance certificate",
    bureaucratic: "Provide proof of comprehensive health coverage.",
    plain:
      "A document from your insurer showing they'll pay for hospital bills while you're abroad.",
  },
  {
    ...
    plain:
      "A paper from the police saying you have no criminal record — must be recent (usually under 3 months old).",
  },
  {
  ...
  },
  {
    ...
    plain:
      "Proof you'll leave before your allowed stay ends — usually a return or next-destination flight.",
  },
  {
    term: "Visa overstay",
    bureaucratic: "Overstays may incur entry bans and administrative sanctions.",
    plain:
      "Staying longer than your visa allows — even by one day — can get you banned from re-entering for years.",
  },
];
...
export const LEGAL_QA: LegalQA[] = [
  {
    ...
    short: "Usually yes",
    answer:
      "Most countries allow students to work part-time — typically 15–20 hours per week during term and full-time in holidays. Germany allows 140 full days / 280 half days a year, France 964 hours/year, the Netherlands 16 hours/week, the UK up to 20 hours/week.",
  ...
  },
  {
    ...
    short: "It depends",
    answer:
      "A standard work or student permit usually only covers a specific employer. To freelance you normally need a self-employment permit (Germany: Freiberufler visa, Spain: cuenta propia, Portugal: D2). Doing freelance work on the wrong permit can void it.",
  },
  {
    id: "stay-after-grad",
    ...
    short: "Usually yes",
    answer:
      "Most EU countries grant a post-study job-search permit of 9–18 months. Germany: 18 months. France: 12 months. Netherlands: 1 year (Zoekjaar). UK: 2-year Graduate visa. You usually have to apply before your student permit expires.",
  },
  {
    id: "schengen",
    ...
    short: "Yes",
    answer:
      "A residence permit from any Schengen country lets you travel to all 29 Schengen countries for up to 90 days in any 180-day period, for tourism. You can't work in another Schengen country without a separate permit.",
    region: "EU / Schengen",
  },
  {
    id: "family-join",
    ...
    short: "Usually yes",
    answer:
      "Most residence permits allow family reunification for spouses, registered partners and minor children. The sponsor usually has to prove enough income (typically the local minimum wage) and adequate housing. Processing can take 2–6 months.",
  },
  {
    id: "drive",
    ...
    short: "It depends",
    answer:
      "Inside the EU/EEA, your licence is valid as long as it's valid at home. From outside, most countries let you drive 6–12 months on your foreign licence (sometimes with an International Driving Permit) before requiring an exchange or local test.",
  },
  {
    id: "open-bank",
    ...
    short: "Usually yes",
    answer:
      "Digital banks (N26, Revolut, Wise, Bunq) let you open an account from abroad in minutes with just a passport. Traditional banks usually need your address registration first.",
  },
  {
    id: "leave-return",
    ...
    short: "Usually no",
    answer:
      "Once you've applied for a residence permit, leaving the country before you get the card (or at least a fiktionsbescheinigung / récépissé) often means you can't re-enter. Always ask the immigration office for a re-entry confirmation first.",
  },
  {
    id: "marry-locally",
    ...
    short: "Yes",
    answer:
      "Foreigners can marry citizens in almost every country. You'll need a passport, a 'no impediment to marry' certificate from your home country (apostilled and translated), and sometimes a residence proof.",
  },
  {
    ...
    short: "Usually yes",
    answer:
      "Most countries grant permanent residency after 5 years of continuous legal stay (EU long-term resident status). Germany: 21–33 months for skilled workers with B1 German. Spain: 5 years. Portugal: 5 years.",
  },
];
